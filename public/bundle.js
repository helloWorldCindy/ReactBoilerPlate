		...
		render: function render() {
			...
			function renderMessage() {
				if (isLoading) return React.createElement(
					...
					null,
					'Fetching Weather...'
				);else if (location && temp) return React.createElement(WeatherMessage, { temp: temp, location: location });
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=e32facacb4f9e1ab10610126e4ebf902&units=metric';
